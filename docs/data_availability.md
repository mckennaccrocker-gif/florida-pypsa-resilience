...
- HIFLD-style transmission line data with geometry, voltage, owner, status, and endpoint attributes
- OSM power plant polygons and OSM substation polygons
- GPPD-style power plant point records
- EIA hourly Florida electricity demand
- EIA fuel, heat-rate, or generator cost data used for marginal-cost assumptions
- static line rating/current data used to estimate PyPSA line capacities
- OpenGIRA/SNAIL tropical-cyclone wind exposure data
- flood return-period raster or exposure files
- county population and county boundary data used for demand weighting and validation maps
- EAGLE-I county outage data used for Hurricane Ian validation
