"""
Use nismod-snail to intersect Florida overhead transmission lines with TC wind rasters.
...
Inputs:
  - data/Exposure/florida_open_gira_tc_exposure/florida_overhead_transmissionlines2.gpkg
  - data/Hazards/Tropical_cyclones/STORM_constant_RP*.tif
  - open_gira_outputs/max_wind_field_FLORIDA_IBTrACS_0.nc

Outputs:
  - data/Exposure/florida_open_gira_tc_exposure/snail_tc_intersection/
"""
...
EXPOSURE_DIR = PROJECT_DIR / "data" / "Exposure" / "florida_open_gira_tc_exposure"
OUTPUT_DIR = EXPOSURE_DIR / "snail_tc_intersection"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

FLORIDA_OVERHEAD_LINES = EXPOSURE_DIR / "florida_overhead_transmissionlines2.gpkg"
...
def read_florida_lines_for_snail(raster_path: Path) -> gpd.GeoDataFrame:
    ...
    lines["source_line_id"] = lines.index
